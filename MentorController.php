...
class MentorController extends Controller
{
    ...
    public function update_settings(Request $request) 
    {
        ...
        $mentor = Mentor::find($mentor_id)->where('profile_status', 'verified')->first();
    ...
    public function data(Request $request)
    {
        ...
        //Update name, email uppon getting data. MOODLE => SME_API;
        ...
        //Setting email and the name.
        //$mentor_data->email=$mentor_moodle_data->email;
        //$mentor_data->name=$mentor_moodle_data->firstname . ' ' . $mentor_moodle_data->lastname;
        //Updating gatherd data...
        //$mentor_data->save();
        
        $unserialize_out = unserialize_out($mentor_data, ['sectors', 'preferred_languages', 'expertise']);
